...
public class JamesHelper {
  ...
  private void initTelnetSession() {
    ...
    //Don't know why it doesn't allow login at thr first attempt - Alexei's notice
    readUntil("Login id:");
    write(login);
    readUntil("Password:");
    write(password);
  ...
  public List<MailMessage> getAllMail(String username, String pasword) throws MessagingException {
