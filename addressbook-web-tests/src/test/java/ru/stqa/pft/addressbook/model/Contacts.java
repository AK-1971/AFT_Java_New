...
public class Contacts extends ForwardingSet<ContactData> { //5.6. с 04.10
  ...
  private Set<ContactData> delegateObject; //создаем объект которому будут делегированы стандартные методы GroupData + наши новые

  public Contacts(Contacts contacts) {
    this.delegateObject = new HashSet<ContactData>(contacts.delegateObject);
  }

  public Contacts() {
    this.delegateObject = new HashSet<ContactData>();
  }

  public Contacts(Collection<ContactData> contacts) { //7.4. на 06.50
    this.delegateObject = new HashSet<ContactData>(contacts);
  }
